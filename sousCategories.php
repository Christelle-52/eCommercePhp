...
<main>
  ...
  <?php
    $stmt = $pdo->prepare('SELECT p.id AS id_produit, p.nom, p.description1, p.description2, p.image, co.prix, co.taille, co.prixKg, ssc.nom AS nom_sous_categorie, ssc.descriptif AS ssc_desc
        FROM produits p 
