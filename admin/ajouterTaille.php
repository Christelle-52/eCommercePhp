...
$stmt = $pdo->prepare('SELECT p.nom FROM produits p
WHERE id = :id');
$stmt->bindValue(':id', $_GET["id_produit"], PDO::PARAM_INT);
$stmt->execute();
$nomProduit = $stmt->fetch();
$stmt->closeCursor();
...
<head>
  ...
  <title>Page Administrateur - Ajouter une taille au produit</title>
...
<body>
  ...
  <main>
    <div class="container text-center my-5">
      <h2 class="p-0 text-center pb-3 my-4">Ajouter une taille à "<?= $nomProduit["nom"] ?>"</h2>

      <div class="container text-center my-5 w-50 formAdmin">
        <form class="m-auto my-2" action='ajouterTailleReq.php' method='POST'>
          <input class="w-50 ps-3" type="hidden" name="id_produit" value="<?= $_GET["id_produit"] ?>"> <br><br>

          <label class="my-3"><strong>Taille</strong></label><br>
          <input class="ps-3 text-center" type="text" name="taille"><br><br>

          <label class="my-3"><strong>Informations</strong></label><br>
          <input class="ps-3 text-center" type="text" name="size"><br><br>

          <label class="my-3"><strong>Prix en €</strong></label><br>
          <input class="ps-3 text-center" type="text" name="prix"><br><br>

          <label class="my-2"><strong>Prix au kg en €</strong></label><br>
          <input class="ps-3 text-center" type="text" name="prixKg"><br><br>

          <label class="my-2"><strong>Stock</strong></label><br>
          <input class="ps-3 text-center" type="text" name="stock"> <br><br>

          <input class="ctaSmall my-2" type="submit" value="Ajouter la taille">
