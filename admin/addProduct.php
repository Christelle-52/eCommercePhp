...
<h1 class="text-center">Ajouter un article</h1>
  <form class="w-50 m-auto" action="addProductReq.php" method="post" enctype="multipart/form-data">
    ...
    <label for="description">Description(s) de l'article</label><br>
    ...
    <label for="image">Image(s) de l'article</label><br>
