...
$stmt = $pdo->prepare('SELECT c.nom FROM categories c
WHERE id = :id');
...
<head>
  ...
  <title>Page Administrateur - Ajouter une sous catégorie</title>
...
<body>
  ...
  <main>
    <div class="container text-center my-5">
      <h2 class="p-0 text-center pb-3 my-4">Ajouter une sous catégorie à "<?= $sousC["nom"] ?>"</h2>

      <div class="container text-center my-5 w-50 formAdmin">
        <form class="m-auto my-2" action='ajouterSousCatReq.php' method='POST'>
          <input class="w-50 ps-3" type="hidden" name="id_categorie" value="<?= $_GET["id_categorie"] ?>"> <br><br>

          <label class="my-3"><strong>Nom</strong></label><br>
          <input class="ps-3 text-center" type="text" name="nom"><br><br>

          <label class="my-2"><strong>Descriptif</strong></label><br>
          <textarea class="ps-3 text-center" type="text" name="descriptif" rows="10"></textarea><br><br>

          <input class="ctaSmall my-2" type="submit" value="Ajouter la sous catégorie">
