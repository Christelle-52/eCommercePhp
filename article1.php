...
$stmt = $pdo->prepare("SELECT * FROM produits p
  ...
  WHERE p.id=".$_GET['id_produit']);
$stmt->execute();
$article = $stmt -> fetchAll(PDO::FETCH_ASSOC);
// var_dump($article);
// var_dump($article[0]['image']);
      ...
      <div class="row m-auto containerProduct">
        ...
        <div class="col-lg-6 col-12 textProduct gx-5">
          ...
          <div class="row selectSizeQty py-4 justify-content-around me-0 ms-0">
            <div class="col-2">
              <span class="control-label bodyBold">Choix :</span>

              
              <select name="size" class="form-control form-control-select" id="selectSize">
                <?php foreach($article as $art){ ?>
                  <!-- $art['id'] renvoie l'id de la table conditionnement -->
            ...
            <div class="col-4 text-bottom">
              <div class="price">
                ...
                <p class="valueProduct"><?=($art['prix']) ?> € </p><small>TTC</small>

              </div>
            </div>
          </div>

          <a class="ctaSmall d-block" href="#">
            <div class="addCard">
      ...
      <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
          <div class="product-description p-3">
            <h2 class="py-2">Fromage de Yak - Friandise d'occupation pour chien</h2>
            <p class="bodyBold">Une friandise appétissante :</p>
            <p>Selon une recette ancestrale Himalayenne, ces friandises sont fabriquées à partir de 100% de lait de
              vache frais récolté en Europe. Le lait est transformé en fromage puis pressé. Il est ensuite séché au
              minima sur 12 semaines.</p>
            <p>Cette friandise 100% naturelle est sans conservateurs, elle ne contient pas de gluten ni de céréales,
              elle est pauvre en lactose et riche en protéine et calcium.</p>
            <p>Saine et naturelle, elle constitue une excellente récompense pour les petits, moyens et grands chiens et
              d'autant plus pour ceux ayant une mastication destructrice</p>
            <p>Un processus de séchage minutieux est employé spécialement pour créer ce fromage pour chien à pâte dure
              de façon à procurer un plaisir de mastication intense pendant de longues heures à votre compagnon.</p>
            <p>Friandise naturelle sans aucun conservateur, colorant ou arôme artificiel, ni liant, additif ou sucre.
            </p>
            <p></p>
            <p><span class="text">Astuces : Pas de perte dans le fromage de Yak pour chien</span> </p>
            <p>Une fois que votre chien a réduit sa friandise en petit morceaux, placez les dans le micro-ondes pendant
              environ 30 à 45 secondes.</p>
            <p>Cela fera gonfler les morceaux et donnera une nouvelle friandise fraiche et croquante à votre compagnon.
            </p>
            <p>Veillez à laisser les morceaux refroidir avant de les donner à votre chien.</p>
            <p></p>
            <p>A conserver dans un endroit frais et sec, à l'abri de la lumière et de l'humidité.</span></p>
            <p>Composition:</p>
            <p>Lait de vache (99%) jus de citron vert et sel. 0% produits chimiques 0% conservateurs. Pas de lactose et
              très faible en matière grasse.</p>
          </div>
        </div>
