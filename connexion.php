...
?>
  ...
  <main>
    <section class="container connexion my-4">
      <div class="row gx-3 justify-content-center">
        <form class="col-xl-8 col-md-8 col-8 formulaire" action="connexionReq.php" method="POST">
          <div class="row champsForm justify-content-center">
            <div class="col-12">
              <label for="email" class="form-label">Email</label>
              <input type="email" name="email" class="form-control" id="inputEmail" placeholder="exemple@server.com"
            ...
            <div class="col-12">
              ...
              <div class="mdp d-flex">
                <input type="password" name="mdp" class="form-control" id="inputPassword1"
                  placeholder="8 car mini, 1 Maj, 1 car spécial et 1 chiffre"
                  value="<?=isset($_COOKIE['mdp'])?$_COOKIE['mdp']:''; ?>"
                  pattern="(?=.*[A-Z])(?=.*\d)(?=.*[@#$%^&+=!])(?=.*[a-zA-Z]).{8,}" required>
            ...
            <div class="col-12">
              <a class="row form-label text-center " href="inscription.php">
                <span class="col-6 create">Pas encore inscrit ?</span>
                <span class="col-6 create">Créer un compte</span>
              </a>
            </div>
            <div class="text-center">
              <input type="submit" class="cta" value="Se connecter">
            </div>
          </div>
        </form>
      </div>
