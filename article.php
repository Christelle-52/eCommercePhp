    ...
    <section class="container">
      ...
      <div class="row m-auto containerProduct">
        ...
        <div class="col-lg-6 col-12 textProduct gx-5">
          ...
          <h3><?php if (!empty($article[0]['classe'])) {
                echo ucfirst($article[0]['classe']);
              } ?></h3>
          <ul>
          ...
          <p><?php if (!empty($article[0]['description2'])) {
                echo ucfirst($article[0]['description2']);
              } ?></span>
          </p>
          <table>
            <tr>
          ...
          <form method="POST" action="addcart.php?id_produit=<?= $id ?>">
            ...
            <div class="row selectSizeQty py-4 justify-content-around me-0 ms-0">
              <div class="col-4">
                ...
                <select name="taille" class="form-control form-control-select" id="selectSize" onchange="modifierPrix(this)">
                  <option value="" data-prix="">Choisissez votre taille</option>
                  <?php foreach ($article as $art) { ?>
                    <option value="<?= $art['id'] ?>" data-prix="<?= $art['prix'] ?>" data-taille="<?= $art['taille'] ?>">
                      <?= $art['taille'] ?>
                    </option>
                  <?php } ?>
                </select>
                <input type="hidden" name="selectedSizeId" value="">
                <input type="hidden" name="selectedSizePrice" value="">
                <input type="hidden" name="selectedSizeTaille" value="">
              ...
              <div class="col-3 text-center">
                ...
                <div class="qty">
                  <div class="input-group">
                    ...
                    <input type="text" name="qty" id="quantity" value="1" class="input-group form-control mx-1 text-center" min="1" aria-label="Quantité">
              ...
              <div class="col-4 text-bottom">
                <div class="price">
                  <p class="valueProduct" id="prix">&nbsp;</p>
                  <small>TTC</small>
                </div>
              </div>
            </div>

            <button type="submit" class="ctaSmall d-block">
              <div class="addCard">
    ...
    <section>
      ...
      ?>
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false">DETAILS DU PRODUIT</button>
          </li>
        </ul>
