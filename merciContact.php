...
<head>
    ...
    <title>ZenDog - Merci de votre message</title>
...
?>
    ...
    <main>
        <div class="container my-4 pt-2 merciContact">
            <em>Merci pour votre message</em>
            <p>Nous nous engageons à répondre dans les 48h (jours ouvrés)</p>
            <p>En attendant, faites plaisir à votre loulou ....</p>
        </div>
    </main>
<?php
  include ('footer.php');
